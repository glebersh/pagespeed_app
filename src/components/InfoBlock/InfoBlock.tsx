      ...
      </Tooltip>
      {
        <CSSTransition nodeRef={infoRef} in={isAnimating} timeout={2000} classNames='info-block-animation' unmountOnExit>
          <Grid gridTemplateColumns='1fr' gridAutoRows='1fr 1fr 1fr 1fr 1fr 1fr' gap='2em' ref={infoRef} mt='3em'>
            <Flex border='1px solid lightgray' borderRadius='15px' p='20px' boxShadow='5px 5px 14px lightgray' w='95%' m='0 auto' direction={{ xs: 'column', lg: 'row' }}>
              ...
              <Text fontSize='20px' m={{ xs: '1em auto 0', lg: '0 3em 0 1em' }} w={{ xs: '90%', lg: '70%' }}>Largest Contentful Paint (LCP) is an important,
            ...
            <Flex border='1px solid lightgray' borderRadius='15px' p='20px' boxShadow='5px 5px 14px lightgray' w='95%' m='0 auto' direction={{ xs: 'column', lg: 'row' }}>
              ...
              <Text fontSize='20px' m={{ xs: '1em auto 0', lg: '0 3em 0 1em' }} w={{ xs: '90%', lg: '70%' }}>First Contentful Paint (FCP) is an important,
            ...
            <Flex border='1px solid lightgray' borderRadius='15px' p='20px' boxShadow='5px 5px 14px lightgray' w='95%'
              m='0 auto'
              ...
              <Text fontSize='20px' m={{ xs: '1em auto 0', lg: '0 3em 0 1em' }} w={{ xs: '90%', lg: '70%' }}>First Input Delay (FID) is an important,
            ...
            <Flex border='1px solid lightgray' borderRadius='15px' p='20px' boxShadow='5px 5px 14px lightgray'
              w='95%' m='0 auto' direction={{ xs: 'column', lg: 'row' }}>
              ...
              <Text fontSize='20px' m={{ xs: '1em auto 0', lg: '0 3em 0 1em' }} w={{ xs: '90%', lg: '70%' }}>Cumulative Layout Shift (CLS) is an important,
            ...
            <Flex border='1px solid lightgray' borderRadius='15px' p='20px' boxShadow='5px 5px 14px lightgray' w='95%' m='0 auto' direction={{ xs: 'column', lg: 'row' }}>
              ...
              <Text fontSize='20px' m={{ xs: '1em auto 0', lg: '0 3em 0 1em' }} w={{ xs: '90%', lg: '70%' }}>Interaction to Next Paint (INP)
            ...
            <Flex border='1px solid lightgray' borderRadius='15px' p='20px' boxShadow='5px 5px 14px lightgray' w='95%' m='0 auto' direction={{ xs: 'column', lg: 'row' }}>
              ...
              <Text fontSize='20px' m={{ xs: '1em auto 0', lg: '0 3em 0 1em' }} w={{ xs: '90%', lg: '70%' }}>Time to First Byte (TTFB)
